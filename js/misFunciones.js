...
function borrarInformacionCategorias(idElemento) {
    ...
    $.ajax({
        dataType: 'json',
        url: 'http://129.151.105.93/api/Category/' + idElemento,
        type: 'DELETE',
...
function obtenerItemEspecificoCategorias(idItem) {
    $.ajax({
        dataType: 'json',
        url: 'http://129.151.105.93/api/Category/' + idItem,
        type: 'GET',
        success: function (response) {
            console.log(response);
...
function actualizarInformacionCategorias() {
    ...
    $.ajax({
        type: "PUT",
        url: 'http://129.151.105.93/api/Category/update',
        dataType: "text",
        async: false,
        data: dataToSend,
        contentType: "application/json; charset=utf-8",
...
function borrarInformacionOrtopedics(idElemento) {
        ...
        $.ajax({
            dataType: 'json',
            url: 'http://129.151.105.93/api/Ortopedic/' + idElemento,
            type: 'DELETE',
            contentType: 'application/json',
            success: function (response) {
                console.log(response);
...
function obtenerItemEspecificoOrtopedics(idItem) {
        $.ajax({
            dataType: 'json',
            url: 'http://129.151.105.93/api/Ortopedic/' + idItem,
            type: 'GET',
            success: function (response) {
                console.log(response);
                var item = response;
...
function actualizarInformacionOrtopedics() {
        ...
        $.ajax({
            type: "PUT",
            url: 'http://129.151.105.93/api/Ortopedic/update',
            dataType: "text",
            async: false,
            data: dataToSend,
            contentType: "application/json; charset=utf-8",
...
function borrarInformacionClients(idElemento) {
    ...
    $.ajax({
        dataType: 'json',
        url: 'http://129.151.105.93/api/Client/' + idElemento,
        type: 'DELETE',
        contentType: 'application/json',
        success: function (response) {
            console.log(response);
...
function obtenerItemEspecificoClients(idItem) {
    $.ajax({
        dataType: 'json',
        url: 'http://129.151.105.93/api/Client/' + idItem,
        type: 'GET',
        success: function (response) {
            console.log(response);
            var item = response;
...
function actualizarInformacionClients() {
    ...
    $.ajax({
        type: "PUT",
        url: 'http://129.151.105.93/api/Client/update',
        dataType: "text",
        async: false,
        data: dataToSend,
        contentType: "application/json; charset=utf-8",
...
function borrarInformacionMessages(idElemento) {
    ...
    $.ajax({
        dataType: 'json',
        url: 'http://129.151.105.93/api/Message/' + idElemento,
        type: 'DELETE',
        contentType: 'application/json',
        success: function (response) {
            console.log(response);
...
function obtenerItemEspecificoMessages(idItem) {
    $.ajax({
        dataType: 'json',
        url: 'http://129.151.105.93/api/Message/' + idItem,
        type: 'GET',
        success: function (response) {
            console.log(response);
            var item = response;
...
function actualizarInformacionMessages() {
    ...
    $.ajax({
        type: "PUT",
        url: 'http://129.151.105.93/api/Message/update',
        dataType: "text",
        async: false,
        data: dataToSend,
        contentType: "application/json; charset=utf-8",
...
function borrarInformacionReservations(idElemento) {
    ...
    $.ajax({
        dataType: 'json',
        url: 'http://129.151.105.93/api/Reservation/' + idElemento,
        type: 'DELETE',
        contentType: 'application/json',
        success: function (response) {
            console.log(response);
...
function obtenerItemEspecificoReservations(idItem) {
    $.ajax({
        dataType: 'json',
        url: 'http://129.151.105.93/api/Reservation/' + idItem,
        type: 'GET',
        success: function (response) {
            console.log(response);
            var item = response;
...
function actualizarInformacionReservations() {
    ...
    $.ajax({
        type: "PUT",
        url: 'http://129.151.105.93/api/Reservation/update',
        dataType: "text",
        async: false,
        data: dataToSend,
        contentType: "application/json; charset=utf-8",
...
function borrarInformacionAdmins(idElemento) {
    ...
    $.ajax({
        dataType: 'json',
        url: 'http://129.151.105.93/api/Admin/' + idElemento,
        type: 'DELETE',
        contentType: 'application/json',
        success: function (response) {
            console.log(response);
...
function obtenerItemEspecificoAdmins(idItem) {
    $.ajax({
        dataType: 'json',
        url: 'http://129.151.105.93/api/Admin/' + idItem,
        type: 'GET',
        success: function (response) {
            console.log(response);
            var item = response;
...
function actualizarInformacionAdmins() {
    ...
    $.ajax({
        type: "PUT",
        url: 'http://129.151.105.93/api/Admin/update',
        dataType: "text",
        async: false,
        data: dataToSend,
        contentType: "application/json; charset=utf-8",
